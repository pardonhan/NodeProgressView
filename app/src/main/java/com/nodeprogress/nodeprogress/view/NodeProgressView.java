...
public class NodeProgressView extends View {
    ...
    private void init() {
        paint = new Paint();
        paint.setColor(ContextCompat.getColor(getContext(), R.color.nodeColor));
        paint.setAntiAlias(true);

        mPaint = new Paint();
        mPaint.setAntiAlias(true);
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.nodeTextColor));

        //画文字
        mPaint.setTextSize(30);

        textPaint1 = new TextPaint();
        textPaint1.setTextSize(35.0F);
        textPaint1.setAntiAlias(true);
        textPaint1.setColor(ContextCompat.getColor(getContext(), R.color.nodeTextColor));

        textPaint2 = new TextPaint();
        textPaint2.setTextSize(35.0F);
        textPaint2.setAntiAlias(true);
        textPaint2.setColor(ContextCompat.getColor(getContext(), R.color.nodeColor));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0 ; i < count; i++) {
            if (i == 0) {
                ...
                //文字换行
                StaticLayout layout = new StaticLayout(((LogisticsData) data.get(i)).getContext() + "", textPaint1, (int) (dWidth * 0.8), Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);
                canvas.save();
                ...
                //文字换行
                StaticLayout layout = new StaticLayout(((LogisticsData) data.get(i)).getContext() + "", textPaint2, (int) (dWidth * 0.8), Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);
